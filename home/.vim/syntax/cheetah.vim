...
"
" Edited by Nathan Reale to add better comment support.
"
" Missing features:
...
syn match   cheetahComment "##.*$" display contains=cheetahTodo,@Spell
syn region  cheetahMultiLineComment start="#\*" end="\*#"
syn keyword cheetahTodo TODO FIXME NOTE NOTES contained
